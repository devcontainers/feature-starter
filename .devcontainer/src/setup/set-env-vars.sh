...
export DEVCONTAINER_FEATURES_SOURCE_ROOT="$DEVCONTAINER_FEATURES_SOURCE_ROOT/src"
export DEVCONTAINER_FEATURES_SCRIPTS_ROOT="$DEVCONTAINER_FEATURES_SCRIPTS_ROOT/scripts"
export DEVCONTAINER_FEATURES_TESTS_ROOT="$DEVCONTAINER_FEATURES_SCRIPTS_ROOT/tests"
