...
$env:DEVCONTAINER_POST_BUILD_SUDO_COMMAND = Get-Content "$env:DEVCONTAINER_SCRIPTS_ROOT/setup/devspace/post-build-sudo" -Raw
$env:DEVCONTAINER_POST_BUILD_USER_COMMAND = Get-Content "$env:DEVCONTAINER_SCRIPTS_ROOT/setup/devspace/post-build-user" -Raw
