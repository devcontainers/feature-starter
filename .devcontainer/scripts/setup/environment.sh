...
DEVCONTAINER_POST_BUILD_SUDO_COMMAND="$(cat "$DEVCONTAINER_SCRIPTS_ROOT/setup/devspace/post-build-sudo")"
export DEVCONTAINER_POST_BUILD_SUDO_COMMAND="$DEVCONTAINER_POST_BUILD_SUDO_COMMAND"
DEVCONTAINER_POST_BUILD_USER_COMMAND="$(cat "$DEVCONTAINER_SCRIPTS_ROOT/setup/devspace/post-build-user")"
