...
scoop update
sudo scoop install --global vcredist vcredist2022 openssh vulkan openssl git-lfs gitsign gh sed curl wget grep sed less touch bzip2 make cmake patch cacert file dos2unix shellcheck zlib age mkcert gcc python dotnet-nightly dotnet-sdk-preview dotnet-sdk dotnet-sdk-lts nvm chezmoi postgresql speedtest-cli speedtest gedit gimp vlc azure-cli aws
sudo scoop update --all --global
